...
//         data: post?.content,
//         tools: {
//           header: { class: Header, inlineToolbar: true, config: { placeholder: "Enter a header", levels: [2, 3, 4, 5, 6], defaultLevel: 2 } },
//           list: List,
//           checkList: CheckList,
//           embed: Embed,
//           linkTool: LinkTool,
...
//               uploader: {
//                 /**
//                  * Upload handler - this function should handle the image upload
//                  * and return the image URL in the correct format.
//                  */
//                 uploadByFile: async (file: File) => {
//                   // Handle image upload using the createImage action or any API
//                   try {
//                     const uploadedImageUrl = await dispatch(createImage(file)).unwrap();
//                     return {
//                       success: 1,
//                       file: {
//                         url: uploadedImageUrl.url,  // The returned image URL
//                       },
//                     };
//                   } catch (error) {
...
//         <Button radius="sm" variant="light" aria-label="Back button" onPress={() => router.back()}>
...
//           >
//             {postType === "PUBLISHED" && isSubmitting ? "Publishing..." : "Publish"}
//           </Button>
//         </div>
//       </nav>
...
//             id="category"
//             {...register("category")}
//             className="w-1/4 mt-2 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
//           >
...
//                 />
//                 <Button color="primary" radius="sm" onPress={handleAddTag}>
//                   Add
//                 </Button>
//               </div>
...
//                   <div
//                     key={tag}
//                     className="flex items-center gap-2 bg-gray-200 rounded-full px-4 py-1"
//                   >
//                     <span>{tag}</span>
//                     <button
//                       type="button"
