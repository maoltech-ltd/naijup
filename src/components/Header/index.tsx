...
//         <Link href="/">
//           <h1 className="text-4xl font-bold text-white dark:text-black text-center">
//             NaijUp
//           </h1>
//         </Link>
//       </div>
...
//         {/* Desktop Navigation */}
//         <nav
//           className="hidden w-max py-3 sm:px-8 px-8 border border-solid border-dark rounded-full font-medium capitalize sm:flex items-center
//         fixed top-13 right-1/2 translate-x-1/2 bg-light/80 backdrop-blur-sm z-40"
//         >
//           <Link href="/" className="mr-2">
//             Market
//           </Link>
//           <button onClick={toggleCategories} className="mx-2">
//             Category
//           </button>
//           {showCategories && (
...
//                     className="block py-2 px-4 rounded-lg text-white dark:text-black hover:bg-gray dark:hover:bg-gray"
//                   >
//                     {category.name}
//                   </span>
//                 </Link>
...
//               ) // Display the icon based on switching state
//             ) : mode === "light" ? (
//               <MoonIcon className={"fill-dark"} />
//             ) : (
//               <SunIcon className={"fill-dark"} />
...
//                 Market
//               </Link>
//               <button onClick={toggleCategories} className="py-2">
//                 Category
//               </button>
//               {showCategories && (
...
//                 onClick={handleThemeChange}
//                 className={cs(
//                   "w-6 h-6 ease mt-2 flex items-center justify-center rounded-full p-1 cursor-pointer",
