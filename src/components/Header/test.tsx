  ...
  return (
    <div>
      ...
      <header className="w-full p-4 px-5 sm:px-10 flex items-center justify-between">
        ...
        {/* Navigation Bar */}
        <nav className={`fixed top-0 left-0 w-full sm:static sm:flex items-center transition-all duration-300 bg-light/80 backdrop-blur-sm z-40 ${click ? 'max-h-screen py-4' : 'max-h-0 overflow-hidden'} sm:max-h-full`}>
          <div className="flex flex-col sm:flex-row sm:px-8 px-4">
