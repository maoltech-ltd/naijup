...
function HeadlineItem({ headline, index }: HeadlineItemProps) {
  ...
  return (
    <div className="flex items-center mx-6 py-1">
      {/* Timestamp */}
      {time && (
        <span className="text-xs text-gray-500 dark:text-gray-400 font-mono mr-3 bg-white dark:bg-gray-700 px-2 py-1 rounded">
          {time}
        </span>
      )}
      ...
      {/* Separator */}
      <div className="w-1 h-1 rounded-full bg-gray-300 dark:bg-gray-600 mx-6" />
    </div>
  );
}